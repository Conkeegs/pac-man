...
export default class ImageRegistry {
	...
	public static readonly IMAGE_LIST: IMAGE_LIST = {
		...
		"pacman-1": ImageRegistry.createImage("pacman-1"),
		...
		"pacman-3-0": ImageRegistry.createImage("pacman-3-0"),
		"pacman-3-1": ImageRegistry.createImage("pacman-3-1"),
		"pacman-3-2": ImageRegistry.createImage("pacman-3-2"),
		"pacman-3-3": ImageRegistry.createImage("pacman-3-3"),
		...
		"blinky-2-0": ImageRegistry.createImage("blinky-2-0"),
		"blinky-2-1": ImageRegistry.createImage("blinky-2-1"),
		"blinky-2-2": ImageRegistry.createImage("blinky-2-2"),
		"blinky-2-3": ImageRegistry.createImage("blinky-2-3"),
		...
		"inky-2-0": ImageRegistry.createImage("inky-2-0"),
		"inky-2-1": ImageRegistry.createImage("inky-2-1"),
		"inky-2-2": ImageRegistry.createImage("inky-2-2"),
		"inky-2-3": ImageRegistry.createImage("inky-2-3"),
		...
		"pinky-2-0": ImageRegistry.createImage("pinky-2-0"),
		"pinky-2-1": ImageRegistry.createImage("pinky-2-1"),
		"pinky-2-2": ImageRegistry.createImage("pinky-2-2"),
		"pinky-2-3": ImageRegistry.createImage("pinky-2-3"),
		...
		"clyde-2-0": ImageRegistry.createImage("clyde-2-0"),
		"clyde-2-1": ImageRegistry.createImage("clyde-2-1"),
		"clyde-2-2": ImageRegistry.createImage("clyde-2-2"),
		"clyde-2-3": ImageRegistry.createImage("clyde-2-3"),
	};
