...
export default class Clyde extends Ghost {
	protected override defaultSprite: SpriteSheetData = this.CLYDE_UP_ANIMATION_STATES[0]!;
	 ...
	 */
	private get CLYDE_UP_ANIMATION_STATES(): SpriteSheetData[] {
		return [
	...
	override get _ANIMATION_STATE_SETS() {
		return {
			default: this.CLYDE_UP_ANIMATION_STATES,
			...
			[MovementDirection.UP]: this.CLYDE_UP_ANIMATION_STATES,
